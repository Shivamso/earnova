...
const Contact = (props: { contactdataNumber: string }) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        fetch("https://formsubmit.co/ajax/earnova2@gmail.com", {
            method: "POST",
    ...
    return (
        <section id="contact" className="py-20 md:py-40 dark:bg-darkblack">
                    ...
                    <div className="flex flex-col xl:flex xl:flex-row gap-15 xl:gap-48">
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">Let’s collaborate and create something amazing! Tell me about your project—<span className="text-black">I’m all ears.</span></p>
                                <div>
