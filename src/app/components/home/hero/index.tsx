                        ...
                        <div className="flex flex-col gap-6 Xxl:pb-20 pb-10">
                            <div className="flex items-start gap-2 md:gap-6">
                                ...
                                <p className="text-white/70 max-w-md">
                                     We build <span className="text-primary">affordable, scalable</span> IT solutions 
  by connecting businesses with skilled freelancers, 
  delivering innovation with <span className="text-primary">real-world impact.</span>
                                </p>
                            </div>
                            <div className="flex flex-col lg:flex-row items-start lg:items-end gap-4">
                                <h1 className="large-heading">Earnova</h1>
                                <div>
