...
const [pricingData, setPricingData] = useState<any>(null);
    ...
    return (
        <section id="price" className="bg-lightgray dark:bg-secondary py-20 md:py-40">
                                        ...
                                        <div key={index} className="bg-white dark:bg-lightgray/10 p-3 sm:p-5 xl:p-12 flex flex-col gap-10">
                                            ...
                                            <div>
                                                <Link href="/#contact" className="group relative flex justify-center items-center w-full bg-primary hover:bg-secondary rounded-full transition-all duration-300 ease-in-out">
                                                    <span className="py-4 px-2 text-lg font-bold text-secondary group-hover:text-white transition-all duration-300 ease-in-out">Lets Talk !</span>
